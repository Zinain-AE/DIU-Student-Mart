        ...
        <form action="{{ route('seller.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}" 
                    class="w-full bg-slate-50 border-2 border-transparent rounded-2xl p-4 focus:bg-white focus:border-blue-500 outline-none transition-all font-bold text-blue-900" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label class="block text-xs font-black text-slate-400 uppercase ml-2 mb-2">Quantity (Stock)</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="department" class="w-full bg-slate-50 border-2 border-transparent rounded-2xl p-4 focus:bg-white focus:border-blue-500 outline-none transition-all font-bold text-slate-600" required>
                ...
                <div>
                    ...
                    <select name="pickup_point" class="w-full bg-slate-50 border-2 border-transparent rounded-2xl p-4 focus:bg-white focus:border-blue-500 outline-none transition-all font-bold text-slate-600" required>
                        ...
                        <optgroup label="Outside Campus Area">
                        ...
                        <optgroup label="Halls / Dormitories">
            ...
            <div>
                ...
                <div class="bg-slate-50 border-2 border-dashed border-slate-200 rounded-2xl p-6 text-center hover:border-blue-400 transition-all">
